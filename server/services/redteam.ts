...
const BANNED_PATTERNS = [
  {
    pattern:
      /\b(kill|murder|assassinate)\s+(someone|people|person|him|her|them)\b/gi,
    category: "violence",
    severity: "HIGH" as const,
  },
  {
    pattern: /\b(make|create|build)\s+(a\s+)?(bomb|explosive|weapon)\b/gi,
    category: "violence",
    severity: "CRITICAL" as const,
  },
  {
    pattern:
      /\b(hack|breach|exploit)\s+(into\s+)?(bank|government|security)\b/gi,
    category: "illegal",
    severity: "HIGH" as const,
  },
  {
    pattern: /\b(steal|rob|theft)\s+(money|data|identity)\b/gi,
    category: "illegal",
    severity: "HIGH" as const,
  },
  {
    pattern:
      /\b(ssn|social\s+security|credit\s+card\s+number|password)\s*[:=]\s*\d+/gi,
    category: "pii",
    severity: "MEDIUM" as const,
  },
  {
    pattern:
      /\b(manipulate|deceive|trick)\s+(into\s+)?(giving|sending|transferring)\b/gi,
    category: "manipulation",
    severity: "MEDIUM" as const,
  },
  {
    pattern: /\b(self-harm|suicide|end\s+my\s+life)\b/gi,
    category: "harm",
    severity: "CRITICAL" as const,
  },
  {
    pattern: /\b(child|minor)\s+(abuse|exploitation|pornography)\b/gi,
    category: "csam",
    severity: "CRITICAL" as const,
  },
];
